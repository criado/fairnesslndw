...
var NEURONS_SERIALIZED='{"neurons":[[100, 200, 0], [200, 200, -1], [200,100, 2], [300,200,-1], [300,100,3], [400,200,-1],[400,100,4],[500,200,-1],[500,100,5], [600,200,1]],"connections":[[0,1,100],[1,3,100], [3,5,100], [5,7,100], [7,9,100], [2,1,100], [3,4,100], [6,5,100], [7,8,100]],"flows":[{"0":{"1": 50},"1":{"3":50}, "3":{"5":50}, "5":{"7":50}, "7":{"9":50}}, {"2":{"1":50}, "1":{"3":50}, "3":{"4":50}}, {"6":{"5":50}, "5":{"7":50}, "7":{"8":50}}]}';
...
function Scene_Propagation(){
	...
	self.transitionOut = function(){
		...
		self.camera.x = 1600; // DAVID: TODO use something like this to move between levels?
		return function(){return (self.cameraEased.x>1600);}; // done when this is
	};
